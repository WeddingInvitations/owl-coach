...
const samplePlans: (TrainingPlan & { id: string })[] = [
  {
    ...
    exercises: [...sampleModules[0].exercises, ...sampleModules[1].exercises],
  ...
  },
  {
    ...
    exercises: [...sampleModules[1].exercises, ...sampleModules[2].exercises],
  ...
  },
  {
    ...
    exercises: [...sampleModules[0].exercises, ...sampleModules[1].exercises, ...sampleModules[2].exercises],
  ...
  },
  {
    ...
    exercises: sampleModules[0].exercises,
    estimatedDuration: 30,
    createdAt: new Date(),
    updatedAt: new Date(),
  },
